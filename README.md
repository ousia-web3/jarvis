...
| Design Taste Skill 가이드 | [docs/design-taste-skill-guide.md](docs/design-taste-skill-guide.md) |
| 실행 트랙 (L0/L1/L2) | [docs/execution-mode-guide.md](docs/execution-mode-guide.md) |
...
4. `work-requests/YYYY-MM-DD-request-slug/` 폴더에 Human Brief, 산출물, 검증 증거를 남깁니다. 웹서비스·랜딩·다페이지 UI 요청이면 Joi가 [IA Brief](templates/ia-brief-template.md)(`ia-brief.md`)를 먼저 작성한 뒤 UX Brief와 구현으로 이어갑니다. 랜딩·포트폴리오 시각 작업은 [Design Taste Skill 가이드](docs/design-taste-skill-guide.md)를 따릅니다.
...
| 3¾. 시각 구현 | 랜딩·포트폴리오·리디자인은 Design Taste Skill로 시각 언어·UI 구현 (분석 대시보드·업무 그리드는 생략) | Joi, TARS |
...
| [skills/](skills/) | Jarvis 운영 스킬(오케스트레이션, Design Review, PRD 기획) |
| [.agents/skills/](.agents/skills/) | Design Taste Skills(랜딩·포트폴리오·리디자인 시각 구현, `skills-lock.json`으로 버전 잠금) |
...
| [docs/design-taste-skill-guide.md](docs/design-taste-skill-guide.md) | 랜딩·포트폴리오 시각 스킬 선택과 Joi/TARS 호출 기준이 필요할 때 |
| [docs/execution-mode-guide.md](docs/execution-mode-guide.md) | L0/L1/L2 실행 트랙과 Design Review 적용 여부를 고를 때 |
