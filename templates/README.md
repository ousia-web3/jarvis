...
이 폴더는 Jarvis 작업에서 반복 사용하는 문서 양식을 보관합니다.
...
- `prd-planning-template.md`: 업무 기획 표준 PRD 6섹션 양식(개요·범위·개선 사항·정책·특이사항·시안)
...
- `work-log-template.md`: 업무 로그 양식
- `episodic-memory-template.md`: 에피소딕 메모리 양식

새 템플릿을 추가하면 `docs/README.md`와 매뉴얼 주요 파일 링크도 함께 갱신합니다.
